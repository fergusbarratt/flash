...
class FlashcardsControllerTest < ActionController::TestCase
  ...
  test "should create flashcard" do
    assert_difference('Flashcard.count') do
      post :create, flashcard: { back: @flashcard.back, deck_id: @flashcard.deck_id, front: @flashcard.front, recent: @flashcard.recent }
    end
  ...
  test "should update flashcard" do
    patch :update, id: @flashcard, flashcard: { back: @flashcard.back, deck_id: @flashcard.deck_id, front: @flashcard.front, recent: @flashcard.recent }
    assert_redirected_to flashcard_path(assigns(:flashcard))
  end
